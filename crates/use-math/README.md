...
<p align="center">
	<strong>Feature-gated <code>RustUse</code> facade for concrete arithmetic helpers, prime utilities, polynomial primitives, equation helpers, structural eigenvalue primitives, approximate numerical helpers, vector primitives, interval primitives, checked counting, Catalan-family sequences, Collatz trajectories, Geode-array primitives, progression helpers, integer helpers, boolean algebra helpers, small set helpers, explicit trigonometry helpers, descriptive statistics helpers, compact linear algebra helpers, finite algebra law helpers, raw-number helpers, complex numbers, numerical calculus, probability, real-number primitives, and rational arithmetic.</strong><br>
...
<p align="center">
	...
	<img alt="Features 28 optional modules" src="https://img.shields.io/badge/features-28%20optional%20modules-c2410c">
...
| `use_math::collatz`       | The `use-collatz` crate as a nested module with trajectory, stopping-time, parity, and bounded range-summary helpers                                                                                                                                                                                                                                                                                                                                                  | Code that prefers explicit Collatz namespacing                    |
...
| Keep structural eigen helpers isolated                      | `use-eigen` directly                   |
...
| Keep geometry-only code isolated                            | `use-geometry` directly (sibling repo) |
...
| Keep Collatz helpers isolated                               | `use-collatz` directly                 |
...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------ | -------------------------------------------------------------------------------------------------------------------- |
| You want one dependency for arithmetic helpers, prime utilities, polynomial primitives, equation helpers, structural eigen primitives, vector primitives, interval primitives, matrix primitives, counting, Catalan-family sequences, Collatz trajectories, Geode-array primitives, progression helpers, integer helpers, boolean algebra helpers, set helpers, trigonometry helpers, descriptive statistics helpers, solver-style linear helpers, raw-number helpers, complex primitives, numerical calculus, probability, real-number helpers, and rational arithmetic | Yes                | The facade keeps imports unified behind features                                                                     |
...
| You only need geometry                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | Usually no         | The sibling `use-geometry` crate stays narrower and more explicit                                                    |
...
| You only need Collatz trajectory helpers                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Usually no         | `use-collatz` keeps trajectory, stopping-time, and parity analysis narrow and explicit                               |
...
| You only need structural eigen primitives                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Usually no         | `use-eigen` keeps eigenvalue and eigensystem vocabulary explicit without implying solver behavior                    |
...
### Eigen primitives from the root

```rust
# #[cfg(feature = "eigen")]
# fn main() -> Result<(), use_math::EigenError> {
use use_math::{Eigenpair, Eigensystem, Eigenvalue, Eigenvector};
...
# fn main() -> Result<(), use_math::numerical::RootError> {
...
# Ok::<(), use_math::numerical::RootError>(())
# }
#
...
| `collatz`       | Re-exports from `use-collatz`, including trajectory, stopping-time, parity, and bounded range-summary helpers                                                                                                                                                                        | No      |
...
| `eigen`         | Re-exports from `use-eigen`, including `Eigenvalue`, `Eigenvector`, `Eigenpair`, `Eigensystem`, `EigenSpace`, `EigenMultiplicity`, and the `use_math::eigen` namespace                                                                                                               | No      |
