...
<p align="center">
	...
	<img alt="Features 20 optional modules" src="https://img.shields.io/badge/features-20%20optional%20modules-c2410c">
...
<table>
	<tr>
		...
		<td width="33%" valign="top">
			...
			Use <code>use_math::arithmetic</code>, <code>use_math::vector</code>, <code>use_math::geometry</code>, <code>use_math::combinatorics</code>, <code>use_math::geode</code>, <code>use_math::number</code>, or <code>use_math::algebra</code> when you want crate-shaped namespacing.
		</td>
		<td width="33%" valign="top">
